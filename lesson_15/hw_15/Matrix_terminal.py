...
if __name__ == '__main__':
    ...
    # python lesson_15/hw_15/Matrix_terminal.py
    # python lesson_15/hw_15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253'
    # python lesson_15/hw_15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253' -operation='='
    # python lesson_15/hw_15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253' -operation='*'