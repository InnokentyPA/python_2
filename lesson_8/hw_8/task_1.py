...
def func(dir)->None:
    ...
    with (open('task_1.json', "w", encoding="UTF-8") as f,
          open('task_1.pickle', 'wb') as f1,
          open('task_1.csv','w',encoding="UTF-8") as f2):
        pickle.dump(res, f1)
...
if __name__=="__main__":
    #for dir_path, dir_name, file_name in os.walk('C:/Users/!!!/Desktop/python_2/python_2/lesson_8'):
    #    print(f'{dir_path = }\n{dir_name = }\n{file_name = }\n')
    func('C:/Users/!!!/Desktop/python_2/python_2/lesson_8')